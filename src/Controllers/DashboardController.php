...
final class DashboardController
{
    ...
    public function stats(): void
    {
        ...
        $revenue        = (int) $db->query("SELECT COALESCE(SUM(subtotal_pesewas), 0) FROM orders WHERE payment_status = 'paid' AND status != 'cancelled'")->fetchColumn();
        ...
        $recent = $db->query(
            'SELECT reference, order_type, customer_name, subtotal_pesewas, status, payment_status, created_at
               FROM orders
